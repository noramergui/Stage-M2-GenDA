...
def main(cfg: DictConfig) -> None:
    ...
    with open('/data2/nora/GenDA_workspace/input_data_gulfstream/diffusion_training_rescale_factors.json', 'r') as f:
    ...
    #ds_clim = xr.open_dataset(data_dir + 'glorys_climatology.nc').astype('float32').isel(depth = 0, drop = True)
    
    
    dataset = Diffusion_Training_Dataset(data_dir = '/data2/nora/GenDA_workspace/input_data_gulfstream/', 
                                         n_lon = 128, 
                                         n_lat = 128, 
    ...
    dataset_val = Diffusion_Training_Dataset(data_dir = '/data2/nora/GenDA_workspace/input_data_azores/', 
                                         n_lon = 128, 
                                         n_lat = 128, 
    ...
    # Training options.
    c.total_kimg = getattr(cfg, "total_kimg", 200000)
    c.ema_halflife_kimg = getattr(cfg, "ema_halflife_kimg", 500)
    c.lr_rampup_kimg = getattr(cfg, "lr_rampup_kimg", 10000)
