...
output_dir          = f'/data2/nora/GenDA_workspace/experiments/exp_{region}_10kimg_128px_batchsize=64/'
...
c.lr_rampup_kimg = 1            # durée du warmup du learning rate en kimg. Exemple lr_rampup_kimg=10000 : le warump dure 10kimg sur 200, soit 5% de l'entrainement, c'est raisonnable.
...
c.wandb_name    = f'exp_{region}_10kimg_128px'
